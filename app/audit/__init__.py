...
def write_audit(
    ...
    *,
    ...
    """
    # code-health: ignore[params] Audit writer contract matches audit_log columns.  # noqa: E501
...
def write_deployment_audit(
    ...
    *,
    ...
    """
    # code-health: ignore[params] Deployment audit rows spell out actor context.  # noqa: E501
    now = (clock if clock is not None else SystemClock()).now()
    row = AuditLog(
        id=new_ulid(),
        workspace_id=None,
