...
def _do_orm_execute(orm_execute_state: ORMExecuteState) -> None:
    # code-health: ignore[ccn] Tenant filter dispatch is explicit SQLAlchemy policy.  # noqa: E501
...
def _walk_from(
    ...
    """
    # code-health: ignore[ccn] SQLAlchemy FROM traversal is branchy by type.  # noqa: E501
