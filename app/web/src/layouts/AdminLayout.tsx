...
const NAV_ITEMS: SideNavItem[] = [
  ...
  { type: "section", label: "LLM" },
  { type: "link", to: "/admin/llm/graph", matchPrefix: "/admin/llm/graph", label: "Graph/config", icon: NAV_ICON(Sparkles) },
  { type: "link", to: "/admin/llm/usage", label: "LLM usage", icon: NAV_ICON(ActivitySquare) },
  { type: "link", to: "/admin/agent-docs", label: "Prompts/docs", icon: NAV_ICON(BookOpen) },
