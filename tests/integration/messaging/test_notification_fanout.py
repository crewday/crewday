...
class TestFanoutEndToEnd:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                NotificationKind.EXPENSE_SUBMITTED,
                {
                    "claim_id": "claim-1",
                    "work_engagement_id": "eng-1",
                    "submitter_user_id": "user-1",
                    "vendor": "Acme Hardware",
                    "currency": "EUR",
                    "total_amount_cents": 1250,
                    "category": "supplies",
                    "purchased_at": "2026-04-22T12:00:00+00:00",
                    "state": "submitted",
                },
                "Acme Hardware",
            ),
            (
                NotificationKind.EXPENSE_APPROVED,
                {
                    "claim_id": "claim-1",
                    "work_engagement_id": "eng-1",
                    "submitter_user_id": "user-1",
            ...
            (
                NotificationKind.EXPENSE_REJECTED,
                {
                    "claim_id": "claim-1",
                    "work_engagement_id": "eng-1",
                    "submitter_user_id": "user-1",
            ...
            (
                NotificationKind.ISSUE_REPORTED,
                {
                    "issue_id": "issue-1",
                    ...
                    "resolved_at": None,
                    "resolved_by": None,
                    "reported_at": "2026-04-24T12:00:00+00:00",
                },
                "Leak under sink",
            ),
            (
                NotificationKind.ISSUE_RESOLVED,
                {
                    "issue_id": "issue-1",
                    "reporter_user_id": "user-1",
                    "property_id": "prop-1",
                    ...
                    "resolved_at": "2026-04-24T12:00:00+00:00",
            ...
            (
                NotificationKind.APPROVAL_NEEDED,
                {
                    ...
                    "card_summary": "Complete turnover task?",
                    "card_risk": "low",
